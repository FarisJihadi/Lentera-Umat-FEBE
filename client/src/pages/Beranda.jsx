          ...
          <div className="w-full md:w-2/3 md:pl-16">
            <div className="space-y-6">
              <div>
                ...
                <p>
                  Memberikan kemudahan bagi masyarakat dalam mengakses sumber
                  belajar yang terpercaya dan sesuai nilai-nilai Islam, melalui
                  buku digital dan fitur AI edukatif.
                </p>
              </div>
              <div>
                <p className="font-bold text-2xl">02</p>
                <p>
                  Menyediakan konten edukatif yang mendorong pemahaman Islam
                  yang toleran, sejuk, dan tidak menyimpang dari nilai-nilai
              ...
              <div>
                ...
                <p>
                  Menghubungkan donatur dengan komunitas yang membutuhkan, agar
                  barang layak pakai bisa dimanfaatkan kembali dan mendukung
                  pemerataan sarana belajar.
                </p>
              </div>
            </div>
          </div>
    ...
    <section className="bg-[#07A5A8] text-white py-16 px-6 md:px-20">
      ...
      <div className="flex flex-col md:flex-row justify-center items-stretch gap-8">
        ...
        <div className="bg-white text-[#205D88] rounded-xl shadow-md p-10 text-center w-full md:w-1/3 flex flex-col justify-center">
          ...
          <p className="mt-2">
            Menjalin kerjasama strategis dengan lembaga dan komunitas
            pendidikan.
          </p>
        </div>
...
const PartnerSec = () => {
  const logos = [komunitas1, komunitas2, komunitas3, komunitas4, komunitas5];
    ...
    <section className="pmt-24 md:mt-0 md:mb-48 bg-white overflow-hidden ">
      ...
      <div className="w-full px-6 md:px-14">
        <div className="flex flex-wrap gap-8 md:gap-12 justify-center md:justify-evenly">
          {[...logos].map((src, index) => (
            <div key={index} className="flex-shrink-0 overflow-hidden">
              <img
                src={src}
