...
import defaultProfilePic from "../../assets/EditProfil/personProfile.png";
    ...
    <>
      <div className="bg-white shadow rounded p-6 border">
        <div className="grid md:grid-cols-[2fr_3fr] gap-6 ">
          ...
          <div className="flex flex-col">
            <div className="flex md:flex-row items-start flex-col gap-4">
              <label className="block mb-2 text-sm font-medium">
                Foto Profil:
              </label>
              <img
                src={
                  filePreview?.url || formData.fotoProfil || defaultProfilePic
                }
                alt="Profil"
                className={`w-36 h-36 rounded-full object-cover ${
                  !filePreview && !formData.fotoProfil ? "p-4 bg-gray-400" : ""
                }`}
              />
              <div className="flex flex-col items-start gap-3">
                <button
                  type="button"
                  className="text-sm border flex items-center gap-2 px-4 py-1 rounded hover:bg-gray-100"
                  onClick={handleClick}
                >
                  Ubah Foto Profil
                  <img src={pensil} alt="" className="w-4 h-4" />
                </button>
                {formData.fotoProfil && (
                  <button
                    type="button"
      ...
      <div className="col-span-2 flex justify-end space-x-3 mt-4">
        <button
          ...
          className="px-5 py-3 border-primary border-2 rounded text-primary hover:bg-gray-100"
        >
          Batal
        </button>
        <button
          onClick={handleSubmit}
          className="bg-primary text-white px-5 py-3 rounded hover:bg-primary-700"
        >
          Simpan Perubahan
        </button>
      </div>
