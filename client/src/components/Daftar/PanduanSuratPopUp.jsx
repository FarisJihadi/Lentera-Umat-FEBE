  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-40 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-[600px] p-6 px-6 md:px-10 pt-10 relative mx-4">
        <button
          className="absolute top-4 right-4 text-gray-500 hover:text-black text-2xl leading-none focus:outline-none"
          onClick={onClose}
          aria-label="Close"
        >
          ×
        ...
        <h2 className="text-xl md:text-2xl font-bold text-primary mb-1">
          Panduan Singkat Upload Google Drive
        </h2>
            ...
            <ul className="text-xs md:text-sm list-disc list-inside">
              ...
              <li>
                ...
                <span className="italic">
                  SuratPendukung_[NamaKomunitas].pdf
                </span>
              </li>
            </ul>
          </div>
