    ...
    const fetchDetail = async () => {
      try {
        ...
        const [userRes, detailRes] = await Promise.all([
          axiosInstance.get(`/user/get/${artikelData.artikelUid}`),
          axiosInstance.get(`/detil/get/${artikelData.artikelUid}`),
        ]);
    ...
    <div className="max-w-5xl mx-auto py-8 px-4">
      ...
      <div className="max-w-4xl mx-auto bg-white rounded shadow-md p-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <Link
            to={`/view-profil/${artikel.artikelUid}`}
            className="informasiPengupload flex gap-3 items-center"
          >
            <img
              src={artikel.fotoProfil}
              alt={artikel.namaLengkap}
        ...
        <div className="text-gray-800 text-lg leading-relaxed mt-6">
          {artikel.deskArtikel.split("\n").map((paragraph, index) => (
