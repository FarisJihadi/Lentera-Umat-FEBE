    ...
    setAllBooks((prevBooks) =>
      prevBooks.map((book) =>
        book._id === bookId
          ? {
              ...book,
              disimpan: isBookmarked
                ? [...(book.disimpan || []), user._id]
                : (book.disimpan || []).filter((id) => id !== user._id),
            }
          : book
      )
    );
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
            ...
            <div className="relative md:w-64 w-full">
              <div
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 cursor-pointer flex justify-between items-center"
              >
