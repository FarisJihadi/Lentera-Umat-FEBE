...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary-dark text-grey-500 text-body-sm mt-4">
      <div className="max-w-7xl mx-auto px-6 md:px-20 py-16 grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Link to={"/ummah-book"} className="hover:underline">
              Ummah Book
            </Link>
            <Link to={"/ummah-partner"} className="hover:underline">
              Ummah Partner
            </Link>
            {user?.role == "donatur" ? (
